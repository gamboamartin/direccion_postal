...
class controlador_dp_calle_pertenece extends _ctl_calles {
    ...
    public function __construct(PDO $link, stdClass $paths_conf = new stdClass()){
        ...
        $this->parents_verifica['dp_colonia_postal']['model_parent'] = (new dp_colonia_postal(link: $this->link));
        $this->parents_verifica['dp_colonia_postal']['etiqueta'] = 'Alta Colonia Postal';
        $this->parents_verifica['dp_calle']['model_parent'] = (new dp_calle(link: $this->link));
        $this->parents_verifica['dp_calle']['etiqueta'] = 'Alta Calle';
