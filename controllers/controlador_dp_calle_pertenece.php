...
class controlador_dp_calle_pertenece extends _ctl_calles {
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $this->keys_selects = array();
        $this->keys_selects['dp_pais_id'] = new stdClass();
        $this->keys_selects['dp_estado_id'] = new stdClass();
        $this->keys_selects['dp_municipio_id'] = new stdClass();
        $this->keys_selects['dp_cp_id'] = new stdClass();
        $this->keys_selects['dp_colonia_postal_id'] = new stdClass();
        $this->keys_selects['dp_calle_id'] = new stdClass();
        $this->keys_selects['codigo'] = new stdClass();

        $this->keys_selects['dp_pais_id']->label = 'Pais';
        $this->keys_selects['dp_estado_id']->label = 'Estado';
        $this->keys_selects['dp_municipio_id']->label = 'Municipio';
        $this->keys_selects['dp_cp_id']->label = 'CP';
        $this->keys_selects['dp_colonia_postal_id']->label = 'Colonia';
        $this->keys_selects['dp_calle_id']->label = 'Calle';
        $this->keys_selects['codigo']->place_holder = 'Cod';
