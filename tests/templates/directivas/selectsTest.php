...
class selectsTest extends test {
    ...
    public function test_dp_calle_pertenece_id(): void
    {
        ...
        $link = $this->link;
        $disabled = false;
        $resultado = $dir->dp_calle_pertenece_id(filtro: $filtro,html:  $html, link: $link,row:  $row, tabla:'dp_calle_pertenece' ,disabled: $disabled);
        $this->assertIsObject($resultado);
        $this->assertNotTrue(errores::$error);
    ...
    public function test_dp_estado_id(): void
    {
        ...
        $filtro =  array();
        $link = $this->link;
        $resultado = $dir->dp_calle_pertenece_entre1_id(filtro: $filtro,html:  $html, link: $link,row:  $row, tabla: 'dp_calle_pertenece');
        $this->assertIsObject($resultado);
        $this->assertNotTrue(errores::$error);
        $this->assertEquals(-1,$resultado->row->dp_calle_pertenece_id);
        $this->assertEquals(-1,$resultado->row->dp_calle_pertenece_entre1_id);
        ...
        $cols = 1;
        $resultado = $dir->dp_calle_pertenece_entre1_id(filtro: $filtro,html:  $html, link: $link,row:  $row, tabla: 'dp_calle_pertenece',cols: $cols );
