...
let asigna_calles = (dp_codigo_postal_id = '') => {
    let url = get_url("dp_calle_pertence","get_calle_pertence", {dp_codigo_postal_id: dp_codigo_postal_id});
    ...
    get_data(url, function (data) {
        ...
        $.each(data.registros, function( index, dp_cp ) {
            integra_new_option(sl_dp_calle_pertenece,dp_calle_pertenece.dp_calle_pertenece_descripcion_select,dp_calle_pertenece.dp_calle_pertenece_id);
        });
        sl_dp_calle_pertenece.selectpicker('refresh');
    });
}
